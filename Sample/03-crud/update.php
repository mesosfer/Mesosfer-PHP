...
// Create Bucket
$data = ['uuid' => 'cb10023fa31833944199a8730c7c1aec', 'major' => 500, 'minor' => 600, 'isEnterState' => 1];

try{

	$respCreateBucket = $client->request('PUT', 'https://api.mesosfer.com/api/v2/data/bucket/'.BUCKET_NAME.'/'.$objectId, [
	    'json'    => ['metadata' => $data],
